...
/**
 * Craft Terms of Service en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('craft-terms-of-service', '...')`) as
 ...
 */
return [
    'Craft Terms of Service plugin loaded' => 'Craft Terms of Service plugin loaded',
];
