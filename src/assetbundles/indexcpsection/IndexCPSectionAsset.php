...
namespace mandarindesign\crafttermsofservice\assetbundles\indexcpsection;
...
class IndexCPSectionAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@mandarindesign/crafttermsofservice/assetbundles/indexcpsection/dist";
